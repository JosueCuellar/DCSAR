...
<div class="row py-lg-2">
  ...
  <div class="col-md-6">
    <a href="{{route('proveedor.create')}}" class="btn btn-primary btn-lg float-md-right" role="button" aria-pressed="true">Nuevo proveedor</a>
  </div>
</div>
        ...
        <tbody>
            @foreach($proveedores as $item)
                ...
                <td>
                    ...
                    <a href="{{route('proveedor.destroy',$item)}}" data-toggle="modal" data-target="#deleteModal" data-categoriaid="{{$item->id}}"><i class="fas fa-trash-alt"></i></a>
                </td>
                </tr>
          @endforeach
        </tbody>
