...
<body style="font-family:'Calibri',sans-serif;">
    <header name="page-header">
        ...
        <p style="margin:2px;text-align:center;">
            ...
            <strong><span style="font-size:15px; opacity: 70%">INFORME TOTAL SALIDAS</strong>
        </p>
        <p style="margin:2px;text-align:center;">
    ...
    <section>
        ...
        <table style="border-collapse:collapse;border:none;">
            ...
            <tbody>
                @foreach ($reporteTotalSalida as $item)
                    <tr>
                        <td
                        ...
                        <td
                            ...
                            <p
                                style="margin-top:0in;margin-right:0in;margin-bottom:0in;margin-left:0in;line-height:normal;font-size:15px;text-align:center;">
                                <span style="font-size:12px;color:black;">${{ number_format($item->sumaTotal, 2) }}</span>
                            </p>
                        </td>
                    </tr>
                @endforeach
