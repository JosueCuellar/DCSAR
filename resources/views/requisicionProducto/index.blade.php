        ...
        <div class="row py-lg-2">
            ...
            <div class="col-md-6">
                <form action="{{route('requisicionProducto.store')}}" method="POST">
                    @csrf
                    <button type="submit" class="btn btn-primary btn-lg float-md-right" role="button" aria-pressed="true">Crear una requisicion</button>
                </form> 
            </div>
        </div>
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane"
                    type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Requisiciones AÚN SIN
                    COMPLETAR</button>
            </li>
        </ul>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                <form action="{{ route('requisicionProducto.index') }}" method="GET">
                    <div style="display: flex; align-items: flex-start; margin-top: 1em;">
                        <div class="col-sm-6">
                            <input  class="form-control float-md-right" type="date" id="start" name="fecha_requisicion" min="2022-01-01">
                        </div>
                        <div class="col-sm-1">
                    ...
                    <tbody>
                        @foreach ($requisiciones as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('requisicionProducto.detalle', $item->id) }}"><i class="fa fa-edit"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
