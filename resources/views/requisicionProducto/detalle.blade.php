            ...
            @if (!($requisicionProducto->estado_id == 3))
                    ...
                    <div class="col-12">
                        <div class="card-body">
                            <button type="submit" data-toggle="modal" data-target="#modalDescripcion"
                                data-categoriaid="{{ $requisicionProducto->id }}" class="btn btn-warning float-md-right"
                                style="margin-bottom:1em">Completar Requisicion</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-7" style="height:40rem;overflow-y: scroll;">
                        <h4>Ingresa los productos a pedir</h4>
                    ...
                    <div class="col-sm-5">
                        <h4>Productos ingresados a la requisicion</h4>
                        <div class="table-responsive" style="margin-top:1em">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Ingresa una descripcion de la requisicion</h5>
